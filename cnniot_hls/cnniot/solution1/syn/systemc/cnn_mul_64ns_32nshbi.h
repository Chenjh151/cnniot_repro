...
// ==============================================================
#ifndef __cnn_mul_64ns_32nshbi__HH__
#define __cnn_mul_64ns_32nshbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_mul_64ns_32nshbi) {
    ...
    SC_CTOR(cnn_mul_64ns_32nshbi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
