...
// ==============================================================
#ifndef __cnn_sdiv_32s_32s_ibs__HH__
#define __cnn_sdiv_32s_32s_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_sdiv_32s_32s_ibs) {
    ...
    SC_CTOR(cnn_sdiv_32s_32s_ibs):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
