...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, in_data_TVALID, out_data_TREADY, ap_ce)
    begin
        case ap_CS_fsm is
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, in_data_TVALID, out_data_TREADY, ap_ce)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or (not(((ap_start = ap_const_logic_0) or (out_data_TREADY = ap_const_logic_0) or (in_data_TVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    ap_ready_assign_proc : process(ap_start, ap_CS_fsm_state1, in_data_TVALID, out_data_TREADY, ap_ce)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (out_data_TREADY = ap_const_logic_0) or (in_data_TVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    in_data_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_state1, in_data_TVALID)
    begin
    ...
    in_data_TREADY_assign_proc : process(ap_start, ap_CS_fsm_state1, in_data_TVALID, out_data_TREADY, ap_ce)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (out_data_TREADY = ap_const_logic_0) or (in_data_TVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_data_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_state1, out_data_TREADY)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_data_TVALID_assign_proc : process(ap_start, ap_CS_fsm_state1, in_data_TVALID, out_data_TREADY, ap_ce)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (out_data_TREADY = ap_const_logic_0) or (in_data_TVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
